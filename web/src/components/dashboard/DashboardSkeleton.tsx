export function DashboardSkeleton() {
  return (
    <div className="animate-pulse space-y-8" aria-busy="true" aria-label="Carregando dashboard">
      <div className="space-y-2">
        <div className="h-9 max-w-md rounded-lg bg-slate-200 dark:bg-slate-700" />
        <div className="h-4 max-w-xl rounded bg-slate-200 dark:bg-slate-700" />
      </div>

        ...
        <table className="w-full min-w-190 text-left text-sm">
          ...
          <tbody>
            {filtered.map((r) => {
              ...
              return (
                <Fragment key={r.id}>
                  <tr className="border-b border-(--border) align-top hover:bg-slate-50/50 dark:hover:bg-slate-800/30">
                    ...
                    <td className="max-w-25 truncate px-3 py-2.5 text-xs text-(--muted)">
                      {r.changed_by ?? "—"}
                    </td>
                    <td className="px-3 py-2.5">
                      <button
